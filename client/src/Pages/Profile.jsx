  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <p className='text-green-500 mt-4 text-center'>{updateSuccess? "User Updated Successfully." : ''}</p>
        {/* <p>
          {
        ...
        <p className='text-sm self-center'>
          {fileUploadError && <span className='text-red-700'>Error Image Upload
        ...
        <Link to={'/create-listing'} className='bg-green-700 p-3
        rounded-lg text-center text-white uppercase hover:opacity-95' >
        Create Listing
        </Link>
    ...
    <div className="flex flex-col gap-4">
        ...
        <div key={listing._id} className="flex justify-between border
        rounded-lg p-3 items-center gap-4 ">
          <Link to={`/listing/${listing._id}`}>
            <img src={listing.imageUrls[0]} alt="listing cover" className='h-16 w-16 object-contain
            ' />
          </Link>
            <Link className='text-slate-700 font-semibold
            flex-1 truncate hover:underline' to={`/listing/${listing._id}`}>
            <p >{listing.name}</p>
             </Link>

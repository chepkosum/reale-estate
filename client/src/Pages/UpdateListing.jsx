        ...
        <main className="p-3 max-w-4xl mx-auto  ">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4"  >
                ...
                <div className=" flex flex-wrap gap-6">
                    ...
                    <div className="flex items-center gap-2">
                        <input type="number" id="regularPrice" min='1000' max='1000000000'
                        required className="p-3 border border-gray-300 rounded-lg"
                        onChange={handleChange}
                    ...
                    {formData.offer &&(
                    <div className="flex items-center gap-2">
                        <input type="number" id="discountedPrice" min='0' max='1000000000'
                        required className="p-3 border border-gray-300 rounded-lg"
                        onChange={handleChange}
                ...
                <div className="flex flex-col flex-1 gap-4 ">
                    ...
                    <div className=" flex gap-4">
                        <input onChange={(e)=>setImages(e.target.files)} className="p-3 border border-gray-300 rounded w-full" type="file" id="images" accept="images/* " multiple />
